...
function usage() {
    ...
    echo "Synchronize specific packages                    : oc_bestsets_media_downloader.sh --deploy-seq=0,1,..."
    echo "Synchronize specific packages (interactive mode) : oc_bestsets_media_downloader.sh --prompt-deploy"
    echo "Show available packages                          : oc_bestsets_media_downloader.sh --show-packages"
    echo "Show synchronized packages                       : oc_bestsets_media_downloader.sh --show-sync"
    echo ""
